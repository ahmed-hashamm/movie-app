...
const FilterComponent = () => {
  return (
    <div className="bg-[#252627] p-6 px-10 text-white">
      <div className="flex flex-col gap-4 ">
        ...
        {/* Genre */}
        <div className="border-b border-gray-700 flex gap-4 pb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <label key={genre} className="flex items-center gap-2">
                <input className="rounded-md outline-none" type="checkbox" name="genre" />
                <span>{genre}</span>
              </label>
            ))}
          </div>
